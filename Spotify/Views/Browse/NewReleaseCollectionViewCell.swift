...
class NewReleaseCollectionViewCell: UICollectionViewCell {
  ...
  override func layoutSubviews() {
    ...
    artistNameLabel.frame = CGRect(x: albumCoverImageView.right + 10, y: albumLabelHeight + 10, width: contentView.width - albumCoverImageView.right - 10, height: 30)

    numberOfTracksLabel.frame = CGRect(x: albumCoverImageView.right + 10, y: contentView.bottom - 44, width: numberOfTracksLabel.width + 20, height: 44)
  }
